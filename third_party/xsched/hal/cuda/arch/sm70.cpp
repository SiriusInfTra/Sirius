...
void InstrumentManager::InstrumentTrapHandler(void *trap_handler_host,
                                              ...
                                              size_t extra_instrs_size)
{
    ...
    uint64_t coveredInstr[2] = {
        ...
        trap_handler_instrs_host[0x260 / 8 + 0],
        trap_handler_instrs_host[0x260 / 8 + 1],
    };

    char jmp_back_instr[INSTR_LEN];
    SetJmpAddr(jmp_back_instr, trap_handler_dev + 0x260 + INSTR_LEN);
    ...
    SetJmpAddr((char *)trap_handler_host + 0x260, extra_instrs_device);
}

void InstrumentManager::GetResumeInstructions(const void **instructions,
                                              size_t *size)
{
...
void InstrumentManager::GetCheckPreemptInstructions(const void **instructions,
                                                    size_t *size)
{
